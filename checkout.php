                 ...
                 <form class="" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-2">
                          	<input type="text" name="product_title" placeholder="Your Address">
                          </div>
                          </label>
                      </div>
                      ...
                      <br>
                                    ...
                                    <div class="col-7">
                                        <div class="custom-select" style="width:200px;">
                                              <select onchange="yesnoCheck(this); wireCheck(this);">
	                                                ...
	                                                <option value="wire">FPX Online Banking</option>
                                              </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-2">
                              <a href="success.php" style="text-align: center;" class="btn">Purchase</a>
                            </div>
                          </div>
                        </div>
                      </div>
